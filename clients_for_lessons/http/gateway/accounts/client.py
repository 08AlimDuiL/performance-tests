...
from clients_for_lessons.http.gateway.cards.client import CardDict
from clients_for_lessons.http.gateway.client import build_gateway_http_client  # Импортируем builder
